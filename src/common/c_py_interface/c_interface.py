...
class CLibInterface:
    ...
    def read_roads(self, nroads, banch):
        ...
        self.c_interface.read_roads(roads.ctypes.data_as(ctypes.c_void_p), ctypes.c_int(nroads),
                                    ctypes.c_int(banch))
    ...
    def write_roads(self, res_roads, banch):
        ...
        self.c_interface.write_roads(np.array(res_roads).ctypes.data_as(ctypes.c_void_p),
                                     ctypes.c_int(res_roads.shape[0]), ctypes.c_int(banch))
