...
def parse_arguments():
    ...
    parser_test_optional_args.add_argument("--batch-size", required=False, type=int, default="16", help="Size of the evaluation batch.", dest="evaluation_batch_size")
    ...
    parser_predict_optional_args.add_argument("--batch-size", required=False, type=int, default="32", help="Size of the prediction batch.", dest="prediction_batch_size")
...
def predict(args):
    ...
    from common.c_py_interface.c_interface import CLibInterface
